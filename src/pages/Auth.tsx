      ...
      <div className="relative z-10 w-full max-w-md bg-card/80 backdrop-blur-xl rounded-[40px] border border-border p-10 shadow-lg animate-fade-in">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {isSignUp ? 'Begin your sensemaking journey.' : 'Return to your sanctuary.'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {isSignUp && (
            <div className="space-y-2">
              <Label htmlFor="displayName" className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Display Name</Label>
              <Input id="displayName" value={displayName} onChange={e => setDisplayName(e.target.value)} placeholder="Your name" className="rounded-2xl h-11" />
            </div>
          )}
          <div className="space-y-2">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={role} onValueChange={(v) => setRole(v as typeof role)} className="space-y-2">
                <div className="flex items-center space-x-3 border border-border rounded-2xl p-3.5 hover:bg-accent/50 transition-colors">
                  ...
                  <div>
                    <Label htmlFor="affected_person" className="text-sm font-semibold cursor-pointer">Affected Person</Label>
                ...
                <div className="flex items-center space-x-3 border border-border rounded-2xl p-3.5 hover:bg-accent/50 transition-colors">
                  ...
                  <div>
                    <Label htmlFor="observer" className="text-sm font-semibold cursor-pointer">Observer</Label>
        ...
        <div className="relative my-5">
          ...
          <div className="relative flex justify-center text-xs uppercase"><span className="bg-card/80 px-3 text-muted-foreground font-semibold tracking-widest">or</span></div>
        </div>
