...
const Auth = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center p-4">
      ...
      <div className="app-card relative z-10 w-full max-w-[31rem] rounded-[2.75rem] p-8 sm:p-10 animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {isSignUp && (
            <div className="space-y-3">
              ...
              <RadioGroup value={role} onValueChange={(v) => setRole(v as typeof role)} className="space-y-2">
                <div className="app-pill-field flex items-center space-x-3 rounded-[1.75rem] p-4">
          ...
          <Button type="submit" className="h-12 w-full text-base sm:h-14" disabled={loading}>
        ...
        <div className="relative my-7">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-card px-4 font-semibold tracking-[0.22em] text-muted-foreground">{t.or}</span>
          </div>
        </div>

        <div className="space-y-3">
          <Button variant="outline" className="h-12 w-full text-base sm:h-14" disabled={googleLoading} onClick={handleGoogleSignIn}>
          ...
          <Button variant="outline" className="h-12 w-full text-base sm:h-14" disabled={appleLoading} onClick={handleAppleSignIn}>
