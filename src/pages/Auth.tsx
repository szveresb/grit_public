      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-card px-2 text-muted-foreground font-mono tracking-widest">or</span></div>
          </div>
          ...
          <Button variant="outline" className="w-full mt-2" disabled={appleLoading} onClick={handleAppleSignIn}>
