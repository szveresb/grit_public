...
export interface Dictionary {
  ...
  questionnaires_manage: {
    ...
    categoryEditorTitle: string;
    categoriesManagementTitle: string;
    existingCategoriesLabel: string;
    editCategoryFormTitle: string;
    newCategoryFormTitle: string;
    deleteCategoryConfirmTitle: string;
    deleteCategoryConfirmDesc: string;
    deleteCategoryInUseError: string;
    categoryKey: string;
    categoryNameHu: string;
    categoryNameEn: string;
    categoryDescHu: string;
