...
export const en: Dictionary = {
  ...
  questionnaires_manage: {
    ...
    interpretationProfileHint: 'Optional clinical profile for score interpretation.',
    interpretationProfileNone: 'None',
    interpretationProfilePvs: 'PVS (Perceived Vulnerability to Disease)',
    interpretationProfileBrcs: 'BRCS (Brief Resilient Coping Scale)',
    answerScores: 'Answer scores',
    interpretation: 'Interpretation',
    interpretationNotePvs: 'Higher scores indicate greater psychological vulnerability. The literature supports a directional interpretation, but it does not define validated clinical cutoffs for this scale.',
    interpretationNoteBrcs: 'Higher scores indicate greater resilient coping. The BRCS literature commonly uses the low / medium / high bands below.',
