...
export const en: Dictionary = {
  ...
  premium: {
    ...
    switchStance: 'Switch',
    observerConsentTitle: 'Third-Party Data Processing',
    observerConsentDesc: 'Observer logging documents behavioral patterns of another person. This data stays exclusively within your account and is never shared.',
    observerConsentCheckbox: 'I confirm that I have the right or intent to document these observations for personal sensemaking or therapeutic use.',
    observerConsentAccept: 'Accept & Continue',
    managedRelativesTitle: 'Managed Relatives',
    managedRelativesDesc: 'Create the people you want to record observations about. This is required before using Observer perspective.',
