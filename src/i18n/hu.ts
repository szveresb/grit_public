...
export const hu: Dictionary = {
  ...
  landing: {
    ...
    heroSubtitle: 'Célunk, hogy segítsünk eligazodni nehéz élethelyzetekben. Hozzáférést a lenti linken kérhetsz.',
    heroTitleBeta: 'A Grit.hu jelenleg zárt bétában érhető el.',
