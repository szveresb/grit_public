...
export const hu: Dictionary = {
  ...
  questionnaires_manage: {
    ...
    interpretationProfile: 'Értelmezési profil',
    interpretationProfileHint: 'Opcionális klinikai profil a pontszám értelmezéséhez.',
    interpretationProfileNone: 'Nincs',
    interpretationProfilePvs: 'PVS (Észlelt betegségfogékonyság)',
    interpretationProfileBrcs: 'BRCS (Rövid reziliencia skála)',
    answerScores: 'Válasz pontszámok',
    interpretation: 'Értelmezés',
    interpretationNotePvs: 'A magasabb pontszám nagyobb pszichológiai sérülékenységet jelez. A szakirodalom irányított értelmezést támogat, de a skálához nem határoz meg validált klinikai küszöböket.',
    interpretationNoteBrcs: 'A magasabb pontszám nagyobb rugalmas megküzdést jelez. A BRCS szakirodalma jellemzően az alábbi alacsony / közepes / magas sávokat használja.',
