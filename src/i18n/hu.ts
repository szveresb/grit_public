...
export const hu: Dictionary = {
  ...
  premium: {
    ...
    loggingFor: 'Naplózás',
    switchStance: 'Váltás',
    observerConsentTitle: 'Harmadik fél adatkezelése',
    observerConsentDesc: 'A megfigyelői naplózás során egy másik személy viselkedési mintáit dokumentálod. Ezek az adatok kizárólag a te fiókodon belül maradnak, és soha nem kerülnek megosztásra.',
    observerConsentCheckbox: 'Megerősítem, hogy jogosult vagyok vagy szándékomban áll ezeket a megfigyeléseket személyes értelmezés vagy terápiás célra dokumentálni.',
    observerConsentAccept: 'Elfogadom és folytatom',
    managedRelativesTitle: 'Megfigyelt személyek',
    managedRelativesDesc: 'Hozd létre azokat a személyeket, akikről megfigyeléseket szeretnél rögzíteni. Ez szükséges a megfigyelői nézőpont használatához.',
